...
export default class Completed extends Component {
  ...
  _render(item) {
    return (
      <Card key={item.key}>
        <Text style={{ marginLeft:16,marginRight:16,marginBottom:10,marginTop:10, borderBottomWidth: 1, borderBottomColor: 'grey', color: 'blue', fontSize: 10 }}>Accepted</Text>
        ...
        <Button style={{position:'absolute',right:0,bottom:16}} small  transparent>
